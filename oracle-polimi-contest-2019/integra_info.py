...
if __name__ == "__main__":
    ...
    #X_train['phone']=[df_new.loc[item.name,'phone'] for item in X_train['phone']]
    #X_train=X_train.apply(foo_bar,args=(X_train,u))
    #print(X_train)
    X_train_pulito=func(X_train,df_new,cols)
    X_train_pulito=X_train_pulito.applymap(lambda x : -1 if x==['missing'] else x)
    ...
    num_miss_phone = X_train_pulito.loc[ (X_train_pulito['phone'])==-1, 'phone' ].shape[0]
    num_miss_address = X_train_pulito.loc[X_train_pulito['address']==-1 , 'address' ].shape[0]
    num_miss_email = X_train_pulito.loc[X_train_pulito['email']==-1 , 'email' ].shape[0]
